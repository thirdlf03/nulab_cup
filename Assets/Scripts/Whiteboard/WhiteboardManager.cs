...
{
    /// <summary>
    /// Maintains an authoritative whiteboard texture.
    ...
    public class WhiteboardManager : NetworkBehaviour
    {
        ...
        [SerializeField] private int baseTextureWidth = 1024;
        [SerializeField] private int baseTextureHeight = 1024;
        ...
        {
            WhiteboardSnapshotReceiver.Instance.ReceiveChunk(chunkData, chunkIndex, totalChunks);
        }
    }
}
#endif
