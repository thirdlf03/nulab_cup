...
{
    public class WhiteboardSnapshotReceiver : MonoBehaviour
    {
        public static WhiteboardSnapshotReceiver Instance { get; private set; }
        ...
        private void ApplySnapshot(byte[] snapshotData)
        {
            ...
            if (WhiteboardManager.Instance == null || WhiteboardManager.Instance.whiteboardRenderer == null)
            {
                return;
            }

            WhiteboardManager.Instance.whiteboardRenderer.material.mainTexture = newTex;
            WhiteboardManager.Instance.whiteboardTexture = newTex;
        }
    }
}
#endif
